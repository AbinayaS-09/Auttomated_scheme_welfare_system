// The SchemeDetail component is responsible for displaying detailed
//  information about a specific government scheme. 
// It fetches the scheme details from the backend API using the 
// scheme ID from the URL parameters. The component includes a hero
//  section with the scheme name, ministry, and an eligibility match badge if available. 
// It also features a tabbed interface to navigate between different sections of the scheme details, such as overview, eligibility 
// criteria, benefits, application process, and required documents.
//  The component handles loading states and errors gracefully, providing feedback to the user. 
// Additionally, it includes links to the official scheme page and allows users to easily
//  navigate back to the list of schemes or their dashboard.
